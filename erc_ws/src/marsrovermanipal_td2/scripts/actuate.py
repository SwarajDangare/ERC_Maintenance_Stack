...
def killer(toKill, aruco):
    ...
    while True:
        ...
        if(len(aruco.aruco)>=9):
            print(aruco.aruco)
            print(os.popen("rosnode list").readlines() +" oyele")
            ...
            try:
                ...
                service_msg.tag5=[0,0,0] #aruco.aruco[5][0]
                service_msg.tag6=[0,0,0] #aruco.aruco[6][0]
                service_msg.tag7=[0,0,0] #aruco.aruco[7][0]
                service_msg.tag8=[0,0,0] #aruco.aruco[8][0]
                service_msg.tag9=[0,0,0] #aruco.aruco[9][0]
